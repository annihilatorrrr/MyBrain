...
actual class AppLockManager(private val activity: AppCompatActivity) {

    private val biometricManager = BiometricManager.from(activity)

    private val resultChannel = Channel<AuthResult>()
    actual val resultFlow: Flow<AuthResult> = resultChannel.receiveAsFlow()
    ...
    actual fun canUseFeature(): Boolean {
